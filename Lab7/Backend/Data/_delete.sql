...
CREATE  INDEX lft_rgt_idx ON  tree_of_life_nested_set(lft, rgt);
CREATE INDEX depth_lft_rgt_idx ON  tree_of_life_nested_set(depth, lft, rgt);
...
CREATE INDEX parent_id_distance_idx  ON tree_of_life_closure_table(ancestor_id, distance);
